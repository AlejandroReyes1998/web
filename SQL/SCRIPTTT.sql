...
insert into Usuario (nombreUsuario,passwor_d,IDPersona,IDCatalogoUsuario) values ("CesarUrico",sha2("cesarurieladmin123",0),1,1),("Matrix",sha2("animel0v3r",0),2,1),("AlejandroR",sha2("JohnCena23231.1",0),3,1);
-- pruebas
select * from Usuario;
select * from Medico;
select * from Persona;
